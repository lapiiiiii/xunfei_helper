...
      <!-- 左侧返回按钮 -->
      <view class="back-btn" >
          <image src="https://i.postimg.cc/x8bRcV1c/o.png" class="back-image" mode="widthFix"></image>
      </view>
      <!-- 中间标题 -->
...
      <image class="enter-icon" src="https://i.postimg.cc/65FPgWTS/pointer.png" mode="aspectFit"></image>
    </button>
    </view>
